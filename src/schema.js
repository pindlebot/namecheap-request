  ...
  'domains': {
    ...
    'create': [
      ...
      },
      {
        ...
        'required': 'Yes',
        'description':
          'Required for .us, .eu, .ca, .co.uk, .org.uk, .me.uk, .nu , .asia, .com.au, .net.au, .org.au, .es, .nom.es, .com.es, .org.es, .de, .fr TLDs only'
      },
      {
        'name': 'Nameservers',
        'type': 'String',
    ...
    'getTldList': [
      { 'number': '2011166', 'description': 'UserName is invalid' },
      { 'number': '3050900', 'description': 'Unknown response from provider' }
    ],
    'setContacts': [
      {
        'name': 'DomainName',
    ...
    'transfer': {
      'create': [
        ...
        },
        {
          ...
          'required': 'No',
          'description':
            'Adds free Whoisguard for the domain Default Value: Yes'
        },
        {
          'name': 'WGenable',
          'type': 'String',
  ...
  'users': {
    ...
    'create': [
      ...
      },
      {
        ...
        'required': 'No',
        'description':
          'By default, it ignores to check if the email address is already in use.  Default Value:  Yes'
      },
      {
        'name': 'FirstName',
        'type': 'String',
      ...
      },
      {
        ...
        'required': 'Yes',
        'description':
          'Terms of agreement. The Value should be 1 for user account creation.  Default Value:  1'
      },
      {
        'name': 'AcceptNews',
        'type': 'Number',
        ...
        'required': 'No',
        'description':
          'Possible values are 0 and 1. Value should be 1 if the user wants to recieve newsletters else it should be 0.'
      },
      {
        'name': 'JobTitle',
        'type': 'String',
  ...
  'whoisguard': {
    ...
    'enable': [
      ...
      },
      {
        ...
        'required': 'Yes',
        'description':
          'The email address to which WhoisGuard emails are to be forwarded'
      }
    ],
    'disable': [
      {
    ...
    'allot': [
      ...
      },
      {
        ...
        'required': 'No',
        'description':
          'The email to which you wish to forward your WhoisGuard emails'
      },
      {
        'name': 'EnableWG',
        'type': 'String',
    ...
    'getList': [
      ...
      },
      {
        ...
        'required': 'No',
        'description':
          'Number of WhoisGuard to be listed on a page. Minimum value: 2; Maximum value: 100'
      }
    ],
    'renew': [
      {
